...
//! modes; Ctrl toggles snapping. Runs only in the SDF editor scene. (Delete/X and the
//! undo/redo/clipboard chords are owned by `editor::history`, which routes them through the
//! command stack so they're undoable.)
